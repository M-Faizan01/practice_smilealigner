<div id="page_content">
    <div id="page_content_inner" class="page_content-p">
        ...
        <br />
        <form id="addScanForm" method="POST" action="<?= site_url('doctor/submitScan'); ?>" enctype="multipart/form-data">
            <input type="hidden" id="patient_id" name="patient_id" value="<?= $patient_id; ?>">
            <div class="uk-grid">
                <div class="uk-width-medium-1-2">
                    <div class="md-input-wrapper">
                            <label class="label-p" for="scan_title"><b>Title</b><span class="req">*</span></label>
                            <input type="text" name="scan_title" id="scan_title" class="md-input demoInputBox input-border" placeholder="Title" style="border-radius: 0px !important;" required>
            ...
            <div class="uk-width-1-1">
                <!-- <input style="float: right;margin-right: 10px;height:40px;" class="md-btn md-btn-primary btnNext" type="submit" name="next" id="create" value="Create"> -->
                <button type="submit" name="submit" id="create" class="md-btn md-btn-primary btnNext borderSetting">Create</button>
                <a href="<?= base_url('doctor/viewPatient/'.$patient_id); ?>" class="md-btn md-btn-primary submitAlignment md-btn-wave-light waves-effect waves-button waves-light themeColor" id="cancelBtn">Cancel</a>
            </div>
        </form>   
    </div>
</div>
                   ...
                   <div class="modal-body">
                     ...
                     <div class="viewButtoMobile">
                        <div class="uk-margin-small-left">
                          <a id="model-close w-100" href="<?php echo base_url('doctor/viewPatient/'.$patient_id); ?>" class="md-btn buttonStyling accept-btn deposit-btn" style="background-color:#56BB6D !important; width: 100%;">
                            Done</a>
                        </div>
                    </div>  
                </div>
