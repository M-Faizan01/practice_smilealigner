                                ...
                                <br>
                                    <div class="uk-grid">
                                      ...
                                      <span class="icheck-inline mt-12p">
                                          ...
                                          <label for="val_radio_male" class="inline-label">Unlimited</label>
                                      </span>
                                  ...
                                  <div class="uk-grid uk-margin-medium-top">
                                      <div class="uk-width-medium-1-3">
                                            <div class="uk-form-row parsley-row">
                                              ...
                                              <span class="icheck-inline mt-12p">
                                                  <input type="radio" value="0" name="ipr_performed" id="val_radio_male" data-md-icheck />
                                                  <label for="val_radio_male" class="inline-label">PUT Sheet Duo</label>
                                              </span>
                                             <!--  <span class="icheck-inline">
                                                  <input type="radio" value="1" name="ipr_performed" id="val_radio_female" data-md-icheck />
                                                  <label for="val_radio_female" class="inline-label">Yes</label>
                                ...
                                <br>
                                 ...
                                 <div class="uk-grid">
                                      <div class="uk-width-medium-1-2">
                                            ...
                                            <input style="border-radius: 7px !important;" type="text" class="md-input input-border"  placeholder="3U 1L" name="" id=""  />
                                      </div>
                                      <div class="uk-width-medium-1-2">
                                            <label class="label-p" for="wizard_email"><b>Remaining <span>(12 Aug, 2021)</span></b></label>
                                            <input style="border-radius: 7px !important;" type="text" class="md-input input-border"  placeholder="2U 1L" name="" id=""  />
                                      </div>
                                  </div>
