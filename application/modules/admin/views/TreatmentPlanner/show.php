                        ...
                        <div class="md-card">
                            ...
                            <div class="user_heading userDataBackground">
                                <div class="user_heading_avatar doctorViewImageSetting">
                                    <div class="thumbnail">
                                        ...
                                        <?php } else{ ?>
                                            ...
                                            $lastName = $plannerData->last_name;
                                ...
                                <div class="user_heading_content doctorViewNameSetting">
                                    <h2 style="color:#6D3745 !important;" class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?= $plannerData->first_name; ?><br><?= $plannerData->last_name; ?></span></h2>
                                </div>
                            </div>
                                ...
                                <ul id="" class="uk-margin">
                                    <div class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        <div class="uk-width-large-2-10">
                                            <span class="themeTextColor"><b>Planner ID</b></span>
                                        </div>
                                        <div class="uk-width-large-6-10">
                                            <span><?= $plannerData->id; ?></span>
                                        </div>
                                    </div>
                                    <div class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        <div class="uk-width-large-2-10">
                                        ...
                                        <div class="uk-width-large-6-10">
                                        <span><?= ($plannerData->email != '') ? $plannerData->email : 'N/A';?></span>
                                        </div>
                                    </div>
                                    <div class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        <div class="uk-width-large-2-10">
                                        ...
                                        <div class="uk-width-large-6-10">
                                        <span><?= ($plannerData->phone_number != '') ? $plannerData->phone_number : 'N/A';?></span>
                                        </div>
                                    </div>
                                    <div class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        <div class="uk-width-large-2-10">
                                    ...
                                    <div class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-large-6-10">
                                        <span><?php 
                                    if(!empty($plannerData->age))
                                        {echo$plannerData->age;}
                                    else
                                        {echo 'N/A';} 
                                ?></span>
                                        </div>
                                    ...
                                    <div id="Div2" class="uk-grid uk-margin-medium-top" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-large-6-10">
                                            <span><?= $plannerData->password; ?></span>
                                    ...
                                    <div class="viewButtoMobile uk-flex-s uk-flex-between" style="padding-right:35px;">
                                        <div  class=" mobileDBESetting">
                                            <a  class="md-btn deleteBorder userDataBackground themeTextColor btnSettings md-btn-success md-btn-wave-light waves-effect waves-button waves-light btnDelete" href="#" onclick="deletePlannerByID('<?= $plannerData->id;  ?>');">Delete</a>
                                        </div>
                                        <div class="uk-flex-s">
                                            <div class="uk-margin-small-right">
                                                <a class="md-btn backViewSetting backbtnSetting borderSetting userDataBackground themeTextColor btnSettings md-btn-success md-btn-wave-light waves-effect waves-button waves-light" href="<?= site_url('admin/treatmentplanner/plannersList'); ?>">Back</a>
                                            </div>
                                            <div class="">
                                                <a class="md-btn editbtnBackground btnSettings md-btn-success md-btn-wave-light waves-effect waves-button waves-light" href="<?= site_url('admin/treatmentplanner/edit/').$plannerData->id; ?>">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </ul>
