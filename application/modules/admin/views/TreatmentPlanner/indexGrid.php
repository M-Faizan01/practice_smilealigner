            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    ...
                    <div class=" doctorGridMargin uk-width-medium-1-2">
                        <a class=" gridAddDoctor md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light buttonStyling" href="<?= site_url('admin/treatmentplanner/addPlanner'); ?>">Add</a>
                        ...
                        <div class="md-card md-card-hover-img">
                            <div class="uk-text-center uk-position-relative">
                                <?php if($doctorList->profile_image!=''){ ?>
                                    <a href="<?= site_url('admin/treatmentplanner/view/').$doctorList->id; ?>"><img class="md-user-image doctorGridImg" src="<?php echo base_url('assets/uploads/images/'. $doctorList->profile_image); ?>"></a>
                                <?php } else{ ?>
                                        <center><a href="<?= site_url('admin/treatmentplanner/view/').$doctorList->id; ?>"><img class="md-user-image doctorGridImg" src="<?php echo base_url('assets/images/round-bg.png'); ?>"><div class="marginprofilepicture" id="profileText">
                                            <?php 
