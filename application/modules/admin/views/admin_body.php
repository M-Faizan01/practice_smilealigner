    ...
    <div id="page_content">
        <div id="page_content_inner" style="margin-top: 10px;">
            <div class="row block-stats">
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'OPG Images'])->from("documents")->get();
                                        // // $query = $this->db->get();
                                        // $count_opg_images = $query->num_rows();
                                        // $opg_images_doc =  $query->result_array();
                                        
                                        // $opg_images_pho = 0;
                                        // for($i=0; $i<=$count_opg_images; $i++){

                                        //     $opg_images_pho =  $this->db->where(['post_id'=>$opg_images_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_opg_images_pho += $opg_images_pho ;
                                               
                                        // }
                                        
                                        // echo $total_opg_images_pho;
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'Lateral C Images'])->from("documents")->get();
                                        // $count_lat_c_images = $query->num_rows();
                                        // $lat_c_images_doc =  $query->result_array();
                                        
                                        // $lat_c_images_pho = 0;
                                        // for($i=0; $i<=$count_lat_c_images; $i++){

                                        //     $lat_c_images_pho =  $this->db->where(['post_id'=>$lat_c_images_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_lat_c_images_pho += $lat_c_images_pho ;
                                               
                                        // }
                                        
                                        // echo $total_lat_c_images_pho;
                                    ?>
                                    </h3>
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'STL File(3D File)'])->from("documents")->get();
                                        // $count_stl_file_images = $query->num_rows();
                                        // $stl_file_images_doc =  $query->result_array();
                                        
                                        // $stl_file_images_pho = 0;
                                        // for($i=0; $i<=$count_stl_file_images; $i++){

                                        //     $stl_file_images_pho =  $this->db->where(['post_id'=>$stl_file_images_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_stl_file_images_pho += $stl_file_images_pho ;
                                               
                                        // }
                                        
                                        // echo $total_stl_file_images_pho;
                                    ?>
                                    </h3>
                                    <p> STL File</p>
                                </div>
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'Treatment Plan'])->from("documents")->get();
                                        // $count_treat_plan_images = $query->num_rows();
                                        // $treat_plan_images_doc =  $query->result_array();
                                        
                                        // $treat_plans_images_pho = 0;
                                        // for($i=0; $i<=$count_treat_plan_images; $i++){

                                        //     $treat_plans_images_pho =  $this->db->where(['post_id'=>$treat_plan_images_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_treat_plans_images_pho += $treat_plans_images_pho ;
                                               
                                        // }
                                        
                                        // echo $total_treat_plans_images_pho;
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'IPR'])->from("documents")->get();
                                        // $count_ipr_images = $query->num_rows();
                                        // $treat_ipr_doc =  $query->result_array();
                                        
                                        // $treat_ipr_pho = 0;
                                        // for($i=0; $i<=$count_ipr_images; $i++){

                                        //     $treat_ipr_pho =  $this->db->where(['post_id'=>$treat_ipr_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_ipr_images_pho += $treat_ipr_pho ;
                                               
                                        // }
                                        
                                        // echo $total_ipr_images_pho;
                ...
                <div class="col-md-3 col-sm-6 py-10p">
                    <a href="<?php echo base_url()?>admin/document/documentList/?image_type=invoice">
                        <section class="panel home_sec_green">
                            <div class="symbol light-cream">
                            ...
                            <div class="value"> 
                                <div class="value-contain">
                                    ...
                                    <?php
                                        ...
                                        // $query = $this->db->where(['file_type'=>'Invoice'])->from("documents")->get();
                                        // $count_invoice_images = $query->num_rows();
                                        // $treat_invoice_doc =  $query->result_array();
                                        
                                        // $treat_invoice_pho = 0;
                                        // for($i=0; $i<=$count_invoice_images; $i++){

                                        //     $treat_invoice_pho =  $this->db->where(['post_id'=>$treat_invoice_doc[$i]['doc_id']])->from("photos")->count_all_results();
                                        //     $total_invoice_images_pho += $treat_invoice_pho ;
                                               
                                        // }
                                        
                                        // echo $total_invoice_images_pho;
                                    ?>
                                    </h3>
                                    <p>Invoice File</p>
                                </div>
                                ...
                                <?php if(!empty($doc_photos)){ ?>
                                    ...
                                    <?php  foreach($doc_photos as $photo){ ?>
                                        <?php if($photo->status != 'Dismiss') {?>
                                            ...
                                            <td>
                                                <?php if(!empty($patient_details['pt_img'])){ ?>
