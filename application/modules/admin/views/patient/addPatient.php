        ...
        <div class="md-card uk-margin-large-bottom">
            <div class="md-card-content">
                ...
                <div id="account-field">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-medium-1-2">
                            <div class="md-input-wrapper"><label class="label-p" for="wizard_fullname"><b>First Name</b><span class="req">*</span></label><input type="text" name="pt_firstname" id="wizard_fullname" class="md-input demoInputBox  input-border" placeholder="First Name"><span class="md-input-bar"></span></div>
                            
                        </div>
                        <div class="uk-width-medium-1-2">
                            <div class="md-input-wrapper"><label class="label-p" for="wizard_fullname"><b>Last Name</b><span class="req">*</span></label><input type="text" name="pt_lastname" id="wizard_fullname" required="" class="md-input demoInputBox  input-border" placeholder="Last Name"><span class="md-input-bar"></span></div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-2">
                            <!-- <div class="uk-input-group"> -->
                                ...
                                <input type="text" class="md-input input-border"  placeholder="Email ID" name="pt_email" id="wizard_email" required />
                            <!-- </div> -->
                        </div>
                    </div>
...
<div class="row imageOpgSetting">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-2">
          <div class="uk-form-row scan-radio-btn">
              <label for="gender" class="uk-form-label"><b>Scan/Impressions</b><span class="req"></span></label>
              <label><input type="radio" name="pt_scan_impression" onclick="show1();" value="no"/>No</label>
              <label><input type="radio" name="pt_scan_impression" value="yes" onclick="show2();" />Yes</label>
              <!-- <span class="">
    ...
    <div class="row imageOpgSetting">
     ...
     <div class="uk-grid">
        ...
        <div class="collapse uk-margin-medium-top" id="featuresData">
            ...
            <div style="display: block;" class="uk-padding-remove-left demo-checkbox col-md-12 uk-margin-small-top">
            ...
            <div class="collapse uk-margin-medium-top" id="featuresData">
                <label for="exampleFormControlFile1 uk-margin-medium-top"><b>Type of case:Malocclusion</b></label><br>
                <div style="display: block;" class="uk-padding-remove-left demo-checkbox col-md-12 uk-margin-small-top">
            ...
            <div class="collapse uk-margin-medium-top" id="featuresData">
                <label for="exampleFormControlFile1 uk-margin-medium-top"><b>Arches to be treated</b></label><br>
                <div style="display: block;" class="uk-padding-remove-left demo-checkbox col-md-12 uk-margin-small-top">
        ...
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-2">
              <div class="uk-form-row parsley-row">
                  <label for="gender" class="uk-form-label uk-margin-medium-top"><b>IPR to be performed</b><span class="req">*</span></label>
                  <span class="icheck-inline">
...
<div id="general-field" style="display:none;">
    ...
    <div class="uk-width-medium-1-3 uk-width-large-1-2 approval-date">
      <!--   <div class="uk-grid">
            ...
            <!-- <label for="exampleFormControlFile1" class="label-p"><b>Approval Date</b></label><br> -->
