...
<div id="page_content">
    <div id="page_content_inner">
        <br>
        <h1 class="headingSize patientMobile"><b>Add Scanner Pro</b></h1>
        <br>
        <div>
            <div class="md-card-content">
                <form method="POST" action="<?= site_url('admin/scannerpro/submitscannerpro'); ?>" enctype="multipart/form-data">
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="uk-form-row">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-medium-1-3">
                                            ...
                                            <input type="number" name="age" min="1" class="md-input input-border" placeholder="Enter Age" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-form-row">
                            ...
                            <div class="uk-width-medium-1-1">
                                ...
                                <a href="<?= site_url('admin/Scannerpro/ScannerProList'); ?>" class="md-btn md-btn-primary submitAlignment md-btn-wave-light waves-effect waves-button waves-light themeColor" href="#" id="cancelBtn">Cancel</a>
                            </div>
                        </div>
                </form>
            </div>
