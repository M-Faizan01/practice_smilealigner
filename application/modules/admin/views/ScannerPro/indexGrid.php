            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium-1-2">
                        <h1 class="heading_a headingSize patientMobile uk-margin-bottom"><b>Scanner Pro</b></h1>
                    </div>
                    <div class=" doctorGridMargin uk-width-medium-1-2">
                        <a class=" gridAddDoctor md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light buttonStyling" href="<?= site_url('admin/scannerpro/addScannerPro'); ?>">Add</a>
                        <a class="buttonAlignment btn-list" href="<?= site_url('admin/scannerpro/scannerProList'); ?>"> 
                            <img src="<?php echo base_url('assets/admin/assets/img/list-icon.svg') ?>">
                        </a>
                        <a class="buttonAlignment btn-grid" href="<?= site_url('admin/scannerpro/scannerProGrid'); ?>">
                        ...
                        <div class="md-card md-card-hover-img">
                            <div class="uk-text-center uk-position-relative">
                                <?php if($doctorList->profile_image!=''){ ?>
                                    <a href="<?= site_url('admin/scannerpro/viewscannerPro/').$doctorList->id; ?>"><img class="md-user-image doctorGridImg" src="<?php echo base_url('assets/uploads/images/'. $doctorList->profile_image); ?>"></a>
                                <?php } else{ ?>
                                        <center><a href="<?= site_url('admin/scannerpro/viewscannerPro/').$doctorList->id; ?>"><img class="md-user-image doctorGridImg" src="<?php echo base_url('assets/images/round-bg.png'); ?>"><div class="marginprofilepicture" id="profileText">
                                            <?php 
