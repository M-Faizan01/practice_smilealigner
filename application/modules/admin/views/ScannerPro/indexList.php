            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <div class="uk-width-medium-1-5 addPatientButton regularButtonAlignment w-xs-auto">
                            <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light buttonStyling" href="<?= site_url('admin/scannerpro/addScannerPro'); ?>">Add</a>
                        </div>
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <?php foreach($accepted_users as $regUsers): ?>
                            <tr>
                                ...
                                <td class="tblRow">
                                    <a href="<?= site_url('admin/scannerpro/viewScannerPro/').$regUsers->id; ?>" title="Info">
                                    ...
                                    <a href="<?= site_url('admin/scannerpro/editScannerPro/').$regUsers->id;; ?>" title="Edit"> 
                                    ...
                                    <a  href="#" onclick="deleteScannerProByID('<?= $regUsers->id;  ?>');"  title="Delete">
                                        <span class="infoIconSetting">
