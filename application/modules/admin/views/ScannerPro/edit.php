...
<div id="page_content">
    <div id="page_content_inner">
         <br>
        <h1 class="headingSize patientMobile"><b>Edit Scanner Pro</b></h1>
        <br>
        <div>
            <div class="md-card-content">
                <form method="POST" action="<?= site_url('admin/Scannerpro/udpateScannerProData'); ?>" enctype="multipart/form-data">
                    <?php foreach($developer_data as $developerData): ?>
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-form-row">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-medium-1-3">
                                            ...
                                            <input type="number" name="age" min="1" class="md-input input-border" placeholder="Enter Age" value="<?= $developerData->age; ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-form-row">
                            ...
                            <div class="uk-width-medium-1-1">
                                ...
                                <a class="md-btn md-btn-primary submitAlignment md-btn-wave-light waves-effect waves-button waves-light themeColor" href="<?= site_url('admin/Scannerpro/ScannerProList'); ?>" id="cancelBtn">Cancel</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </form>
