    ...
    <script src="<?= base_url(); ?>assets/admin/assets/js/custom/sweetalert2.all.min.js" type="text/javascript"></script>

    <script src="<?= base_url(); ?>assets/admin/assets/js/custom/sweet_custom.js" type="text/javascript"></script>
    ...
    <ul class="uk-navbar-nav user_actions">
        ...
        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
            ...
            <div style="padding: 15px; border-radius: 10px;" class="uk-dropdown uk-dropdown-small">
                <span style="margin-left: 27px; margin-bottom: 10px;"><label>Hi, <?= $admin_data['first_name']; ?></label></span>
                <ul class="uk-nav js-uk-prevent">
                    <li><a href="<?= site_url('admin/profile'); ?>"><span class="material-icons">person</span>&nbsp&nbsp&nbsp&nbsp<span>My profile</span></a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
      var firstName = '<?= $admin_data['first_name']; ?>';
      var lastName = '<?= $admin_data['last_name']; ?>';
