                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-4-6">
                                        ...
                                        <div style="display:flex;">
                                            ...
                                            <input type="text" name="doctor_name" class="md-input" required/>
                                        </div>
                                    </div>
            ...
            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-3">
                <div class="md-card md-card-hover-img" style="">
                    <div class="uk-text-center uk-position-relative card-inside-p" style="">
                        ...
                        <?php } else{ ?>
                        <center><a href="<?= site_url('admin/doctor/viewDoctor/').$doctorList->id; ?>"><img class="md-user-image doctorGridImg" src="<?php echo base_url('assets/uploads/images/round-bg.png'); ?>"><div class="marginprofilepicture" id="doctorGripText">
                            <?php
                    ...
                    <div>
                        ...
                        <center class="card-b-txt" style=""><span class="sub-heading" ><b style="color:#71453C;font-weight: normal;">Email</b> <?= $doctorList->email; ?></span></center>
                        <center class="card-b-txt" style=""><span class="sub-heading"><b style="color:#71453C;font-weight: normal;">Mobile No </b><?= $doctorList->phone_number; ?></span></center>
                        <center class="card-b-txt" style=""><span class="sub-heading"><b style="color:#71453C;font-weight: normal;">GST No </b><?= $doctorList->gst_no; ?></span></center>
                        </h4>
                    </div>
                </div>
            </div>
