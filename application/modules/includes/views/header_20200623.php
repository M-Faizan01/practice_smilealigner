...
<head>
    ...
    ?>
    <style>
        #doctor_login_modal .modal-header, #doctor_login_modal h4, #doctor_login_modal .close {
        ...
        <div class="ubea-container">
            <div class="row">
                <div class="col-sm-3 col-xs-12">
                    <div id="ubea-logo"><a href="<?php echo base_url(); ?>"><img style="max-width: 200px;margin: 5px auto;" class="headerlogo" src="<?php echo base_url("assets/images/new/smilealigners_logo_02.png")?>"></a></div>
                </div>
