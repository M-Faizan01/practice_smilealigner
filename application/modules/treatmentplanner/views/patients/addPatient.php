                ...
                <div id="account-field">
                    <div class="uk-grid">
                        <div class="uk-width-medium-1-2">
                            <div class="md-input-wrapper"><label for="wizard_fullname"><b>First Name</b><span class="req">*</span></label><input type="text" name="pt_firstname" id="wizard_fullname" required="" class="md-input demoInputBox"><span class="md-input-bar"></span></div>
                            
                        </div>
                        <div class="uk-width-medium-1-2">
                            <div class="md-input-wrapper"><label for="wizard_fullname"><b>Last Name</b><span class="req">*</span></label><input type="text" name="pt_lastname" id="wizard_fullname" required="" class="md-input demoInputBox"><span class="md-input-bar"></span></div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-2">
                            <div class="uk-input-group">
                                ...
                                <input type="text" class="md-input" name="pt_email" id="wizard_email" required />
                            </div>
                        </div>
                    </div>
...
<div class="row imageOpgSetting">
    ...
    <div id="div1" class="row imageOpgSetting hide">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          </div>    <div class="row imageOpgSetting">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div class="form-group alert-up-pd">
             <div class="panel panel-default">
     ...
     <div class="uk-grid">
        <div class="uk-width-1-1">
            ...
            <label for="exampleFormControlFile1"><b>Treatment Objective</b></label><br><br>
                <textarea placeholder="lorem ipsum" class="md-input" name="pt_objective" cols="10" rows="8" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-validation-threshold="10" data-parsley-minlength-message = "Come on! You need to enter at least a 20 caracters long comment.."></textarea>
            </div>
        </div>
    </div>
            ...
            <select id="select_demo_1" name="pt_referal" data-md-selectize>
                <option value=""><b>Referral Name</b></option>
                   <?php foreach($reference_doctor as $referDoctor){?>
                     <option value="<?= $referDoctor->ref_id;?>"><?= $referDoctor->doctor_name;?></option>
                   <?php } ?>
            </select>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-size"> 
        <div  class="modal-content">
            ...
            <div class="modal-footer">
                            ...
                            <button type="button" id="cropClose" class="btnBack" data-dismiss="modal">Cancel</button>
                        </div>
        </div>
    </div>
    </div>
