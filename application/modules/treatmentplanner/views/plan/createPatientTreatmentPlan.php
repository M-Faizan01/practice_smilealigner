            ...
            <div class="md-card-content" style="margin-top:33px;">
                ...
                <form method="POST" action="<?= site_url('treatmentplanner/patient/submitPlan'); ?>" enctype="multipart/form-data">
                    <input type="hidden" name="patientID" value="<?= $patientID ?>">
                        ...
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-medium-1-2 mt-20p">
                                ...
                                <div class="uk-button uk-form-select custom-uk-select" data-uk-form-select style="
                                    ...
                                    <i class="uk-icon-caret-down custom-uk-selectDropIcon"></i>
                                    <select name="patientID" class="patient_name" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="uk-width-1-1 mt-15p" style="margin: 0px 3px;">
                            <div class="">
                                <label class="label-p" for="exampleFormControlFile1"><b>Treatment Plan*</b></label><br><br>
                                <!-- <label for="message">Message (20 chars min, 100 max)</label> -->
                                <textarea placeholder="Enter here" class="md-input input-border" name="plan_detail" cols="10" rows="8" data-parsley-trigger="keyup" data-parsley-validation-threshold="10" data-parsley-minlength-message = "Come on! You need to enter at least a 20 caracters long comment.."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-1-1 mt-20p" style="margin: 0px 3px;">
                            ...
                            <label class="label-p" for="exampleFormControlFile1"><b>Link*</b>
                             </label>
                             <br><br>
    ...
    $(document).ready(function(e) {
        $("#plan_pdf_files").change(function(e){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "uploadCreatePatientPlanFile",
