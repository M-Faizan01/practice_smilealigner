    ...
    <ul class="uk-navbar-nav user_actions">
        ...
        <li class="signedInSetting signINMobile">
            <span>
                ...
                <br>
                <b><span><?= $userdata['first_name']; ?> <?= $userdata['last_name']; ?></b></span>
        </span></li>
        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
            <a href="#" class="user_action_image uk-flex uk-flex-middle pl-0">
                <?php if($userdata['profile_image']!=='') { ?>
                    <img class="md-user-image top-profile-img" src="<?= base_url('assets/uploads/images/').$userdata['profile_image']; ?>" alt=""/>
                <?php } else{ ?>
            ...
            <div style="padding: 15px; border-radius: 10px;" class="uk-dropdown uk-dropdown-small">
                ...
                <ul class="uk-nav js-uk-prevent">
                    <li><a href="<?= site_url('treatmentplanner/profile'); ?>"><span class="material-icons">person</span>&nbsp&nbsp&nbsp&nbsp<span>My profile</span></a></li>
