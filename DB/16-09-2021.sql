...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2021 at 03:14 PM
...
(245, 118, 'Intra Oral Images', NULL, '2021-09-16', 1, 'Pending'),
(246, 118, 'OPG Images', NULL, '2021-09-16', 1, 'Pending');
...
(118, 235, 'Mr. Ali', 'Rehman', 'male', 'client@test.com', '1631795654.png', NULL, 'Treatment Objective', '1', '[\"Overjet\"]', '[\"Class 2\"]', '[\"Lower\"]', '1', '1', 'Treatment Plan', '0', '26.08.2021', 'xx', 'ccccccccc', 'xxxxxx', 'xzzzzzzz', '534', '42', '', '588 Gabe Forge Apt. 569', '20.08.2021', '1', 1, '2021-09-16', 'Pending');
...
(1196, 'Intra Oral Images', 'patient', '245', '118', '163179570425681.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1197, 'Intra Oral Images', 'patient', '245', '118', '163179570426348.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1198, 'Intra Oral Images', 'patient', '245', '118', '163179570426956.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1199, 'OPG Images', 'patient', '246', '118', '163179570457661_dark-desktop-backgrounds-1920x1080.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1200, 'OPG Images', 'patient', '246', '118', '1631795704106677.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1201, 'OPG Images', 'patient', '246', '118', '1631795704167316.jpg', '1', '2021-09-16 12:35:04', 'Pending'),
(1202, 'OPG Images', 'patient', '246', '118', '1631795704195924.jpg', '1', '2021-09-16 12:35:04', 'Pending');
...
(236, 'Dr. Faizan', 'Ali', NULL, '', '67290840834598', 'client@test.com', NULL, NULL, 'iuytrew', '588 Gabe Forge Apt. 569', NULL, NULL, NULL, NULL, '899', 'Friends', 'fgf', '16317959891567226936Baby.tux-800x800.png', 2, 0, 0, 0, '2021-09-16', '2021-09-16 12:39:49');
...
--
ALTER TABLE `documents`
  MODIFY `doc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;

--
-- AUTO_INCREMENT for table `patients`
--
ALTER TABLE `patients`
  MODIFY `pt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `photos`
--
ALTER TABLE `photos`
  MODIFY `photos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1203;
...
--
ALTER TABLE `rejected_history`
  MODIFY `rej_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `tbl_login_log`
  MODIFY `login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=610;
